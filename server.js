...
const allowedOrigins = ['https://powerbi-app.netlify.app', 'http://localhost:3000', 'http://localhost:5000','https://powerbi-app-git-main-george-angelidis-projects.vercel.app'];
app.use(cors({
